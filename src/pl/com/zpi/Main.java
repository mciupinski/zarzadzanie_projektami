...
public class Main {
	...
	public static void main(String[] args) {
		...
		JComboBox number1ComboBox = new JComboBox(Calc.comboBox1NumbersArray);
		JComboBox number2ComboBox = new JComboBox(Calc.generateRandomNumbers(COMBO_BOX2_NUMBERS_QUANTITY));
